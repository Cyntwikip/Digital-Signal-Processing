...
%total_length = 1:length(xt);
%yt(total_length) = xt(total_length) + 0.9.*xt(total_length-(0.2/(1/fs)));

echo_delay = 0.00;  %time delay for echo
delay = zeros(1,echo_delay/(1/8000));
echo = [1, delay, .7, delay, .4];
